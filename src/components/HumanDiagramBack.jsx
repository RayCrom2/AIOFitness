...
// ---- Back body data (from your TypeScript, converted to JS) ----
export const bodyBack = [
  ...
  // Forearm
  {
    ...
    path: {
      left: [
        ...
        "M864.24 682.58q15.09-28.18 25.12-58.55c8.14-24.63 13.67-42.4 20.79-60.35q3.31-8.37 12.08-9.63c1.35-.2 3.68-.75 4.86.21q1.13.93.61 2.3-5.8 15.45-12.04 29.88c-5.79 13.39-14.92 28.68-20.32 40.14-6.12 13-28.07 59.18-31.64 56.64a.21.21 0 01-.21-.35z",
      ],
      right: [
  ...
  // Abductors (approximate lateral hip area)
  {
    slug: "abductors",
    color: "#3f3f3f",
    path: {
      left: [
        // small ellipse placed over the lateral hip area (approximate)
...
// ---- Grouping + styling (similar to front diagram) ----
const GROUPS = ["Shoulders", "Back", "Arms", "Core", "Legs"];
const GROUP_TO_SLUGS = {
  Shoulders: ["deltoids", "trapezius", "neck"],
  Back: ["upperback", "lowerback"],
  Arms: ["triceps", "forearm", "hands"],
  Core: ["adductors"],
  Legs: ["gluteal","abductors","hamstring", "calves", "ankles", "feet"],
};
 ...
 */
export default function BodyDiagramBack({
  selectedSlugs,
  onChange,
  width = 360,
  height,
  ...
  return (
    <div aria-label="Interactive human muscle diagram">
      ...
      >
        ...
        <g filter="url(#shadow-back)">
          {bodyBack.map((part) => {
            ...
            const fill = (active) => (active ? HIGHLIGHT : BASE_FILL);
            const opacity =
            ...
            return (
              <g
                key={part.slug}
                className={`muscle ${isSelected ? "selected selected-back" : ""}`}
      ...
      {/* Legend / group buttons, same look as front */}
